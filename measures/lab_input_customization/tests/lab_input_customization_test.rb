...
class LabInputCustomizationTest < Minitest::Test
  # def setup
  # end
  ...
  def test_number_of_arguments_and_argument_names
    ...
    measure = LabInputCustomization.new
    ...
    assert_equal('lab_type', arguments[0].name)
  end
  ...
  def test_good_argument_values
    ...
    path = "#{File.dirname(__FILE__)}/lab_example_model.osm"
