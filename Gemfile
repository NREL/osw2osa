...
gem 'openstudio-model-articulation', '~> 0.11', '>= 0.11.0'
gem 'openstudio-common-measures', '~> 0.11', '>= 0.11.0'
gem 'openstudio-ee', '~> 0.11', '>= 0.11.0'
gem 'openstudio-calibration', '~> 0.11', '>= 0.11.0'
